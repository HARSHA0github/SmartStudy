...
# Always load .env from the project root, even if PyCharm's working directory differs.
...
def get_ai_reply(user_message: str) -> str:
    ...
    system_prompt = (
        "You are SmartStudy, a study tutor who explains concepts FAST and SIMPLE.\n"
        "STRICT RULES:\n"
